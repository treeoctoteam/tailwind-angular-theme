...
import { CanvasActions } from './canvas-drawer.model';
import { ElementDimension, ENDocumentField } from './canvas-drawer.model';

const getElementDimensions = (element: HTMLElement): ElementDimension => {
  return {
...
@Injectable()
export class ENCanvasDrawerService {
